...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<Menu>> menu = new ArrayList<>();
        ArrayList<Menu> fastFoodList = new ArrayList<>();
        ArrayList<Menu> dessertList = new ArrayList<>();
        ArrayList<Menu> hotDrinks = new ArrayList<>();
        ArrayList<Menu> coldDrinks = new ArrayList<>();

        Menu ff1 = new FastFood("Burger", 5.95f, "101101");
        Menu ff2 = new FastFood("Pizza", 9.95f, "101102");
        Menu ff3 = new FastFood("Fries", 3.95f, "101103");
        Menu des1 = new Dessert("Cheese Cake", 3.45f, "101201");
        Menu des2 = new Dessert("Apple Pie", 2.45f, "101202");
        Menu des3 = new Dessert("Donut Holes", 2.95f, "101203");
        Menu hotDr1 = new HotDrink("Tea", 2.95f, "101301");
        Menu hotDr2 = new HotDrink("Coffee", 4.45f, "101302");
        Menu hotDr3 = new HotDrink("Hot Chocolate", 3.95f, "101303");
        Menu coldDr1 = new ColdDrink("Pepsi", 3.85f, "101401");
        Menu coldDr2 = new ColdDrink("Fanta", 3.85f, "101402");
        Menu coldDr3 = new ColdDrink("Sprite", 3.85f, "101403");
                                        ...
                                        try {
                                            ...
                                            switch (scan.next()) {
                                                ...
                                                case "3":
                                                    ...
                                                    Menu chosenItem = menu.get(menuCategoryNumber - 1).get(chosenItemNumber - 1);
                                                            ...
                                                            switch (scan.next()) {
                                                                ...
                                                                case "3":                 // Add New Item
                                                                    ...
                                                                    switch (menuCategoryNumber - 1) {
                                                                        case 0:
                                                                            Menu newFF = new FastFood(nameOfNewProduct, priceOfNewProduct, codeOfNewProduct);
                                                                            ...
                                                                            break;
                                                                        case 1:
                                                                            Menu newDes = new Dessert(nameOfNewProduct, priceOfNewProduct, codeOfNewProduct);
                                                                            ...
                                                                            break;
                                                                        case 2:
                                                                            Menu newHotD = new HotDrink(nameOfNewProduct, priceOfNewProduct, codeOfNewProduct);
                                                                            ...
                                                                            break;
                                                                        case 3:
                                                                            Menu newColdD = new ColdDrink(nameOfNewProduct, priceOfNewProduct, codeOfNewProduct);
                            ...
                            if (a.get(0).equals(username) && a.get(1).equals(password)) {
                                ...
                                while (flagMenu) {                                                                 //Back to Menu
                                    try {
                                        ...
                                        int categoryNumber = Integer.parseInt(opt);
                                        for (int i = 0; i < menu.get(categoryNumber - 1).size(); i++) {
                                            System.out.printf("%d. %s\n", i + 1, menu.get(categoryNumber - 1).get(i).getName());
                                        }

                                        String opting = scan.next();
                                        int itemNumber = Integer.parseInt(opting);

                                        Menu chosenProduct = menu.get(categoryNumber - 1).get(itemNumber - 1);
